...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &clusterv1beta1.Migration{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &clusterv1beta1.Migration{},
	})
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=cluster.odoo.io,resources=migrations,verbs=get;list;watch;create;update;patch;delete
func (r *ReconcileMigration) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the Migration instance
	instance := &clusterv1beta1.Migration{}
