...
func TestReconcile(t *testing.T) {
	...
	instance := &clusterv1beta1.OdooCluster{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
	...
	// Create the OdooCluster object and expect the Reconcile and Deployment to be created
