...
// Package v1beta1 contains API Schema definitions for the instance v1beta1 API group
// +k8s:openapi-gen=true
// +k8s:deepcopy-gen=package,register
// +k8s:conversion-gen=github.com/xoe-labs/odoo-operator/pkg/apis/instance
// +k8s:defaulter-gen=TypeMeta
// +groupName=instance.odoo.io
package v1beta1
...
var (
	...
	SchemeGroupVersion = schema.GroupVersion{Group: "instance.odoo.io", Version: "v1beta1"}
