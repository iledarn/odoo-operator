...
func TestReconcile(t *testing.T) {
	...
	instance := &instancev1beta1.OdooInstance{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
	...
	// Create the OdooInstance object and expect the Reconcile and Deployment to be created
