...
func TestReconcile(t *testing.T) {
	...
	instance := &clusterv1beta1.Migration{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
	...
	// Create the Migration object and expect the Reconcile and Deployment to be created
