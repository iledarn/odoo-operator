...
func TestReconcile(t *testing.T) {
	...
	instance := &instancev1beta1.InstanceMigration{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
	...
	// Create the InstanceMigration object and expect the Reconcile and Deployment to be created
